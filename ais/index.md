...
This is the `jekyll_kramdown` plugin, which provides kramdown-specific
functionality for Jekyll sites. It extends Jekyll's markdown processing
capabilities with additional kramdown features.

See `$agent_instructions/ruby_standards.md` for Ruby and Jekyll coding
instructions.
